...
<img src="https://cdn.programiz.com/sites/tutorial2program/files/graph-bfs-step-0.png" alt="bfsexample" width="80%" style="filter: opacity(0.1) drop-shadow(0 0 0 blue);">
